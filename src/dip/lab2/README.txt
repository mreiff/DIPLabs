...
DIP RULES:
    A. HIGH LEVEL Classes SHOULD NOT DEPEND UPON LOW
       LEVEL Classes. BOTH SHOULD DEPEND UPON ABSTRACTIONS.
...
need to make some changes to the low-level classes, which have been provided.

Once you have done this you need to test your code in the startup class.
